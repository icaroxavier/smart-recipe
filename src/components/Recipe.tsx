  ...
  return (
    <div className="flex w-full flex-col rounded-lg bg-white p-5 shadow-xl">
      ...
      <div className="mt-4 flex flex-wrap gap-2 text-sm">
        <span className="font-medium text-zinc-600">Você utilizará:</span>
      ...
      <h4 className="mb-1 mt-4 text-zinc-600">Ingredientes necessários: </h4>
      ...
      <h4 className="mb-1 mt-4 text-zinc-600">Passo a Passo: </h4>
